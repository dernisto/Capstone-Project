...
export interface AIChatBoxProps {
  ...
  /** Unique chat ID - changing this triggers message sync (default: "default") */
  chatId?: string;
...
export function AIChatBox({
  ...
  // Ensure we always pass a stable array to useChat and setMessages (AI SDK requires iterable)
