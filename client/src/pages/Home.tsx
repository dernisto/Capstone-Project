  ...
  const features = [
    {
      ...
      description: "Live quiz sessions with instant feedback and scoring",
      path: "/teacher-dashboard",
    },
    {
      icon: Users,
      title: "Multiplayer Sessions",
      description: "Teachers host, students join with PIN codes",
      path: "/quiz-library",
    },
    {
      icon: BarChart3,
      title: "Live Leaderboard",
      description: "Real-time rankings and performance tracking",
      path: "/teacher-dashboard",
    },
    {
      icon: Clock,
      title: "Timed Questions",
      description: "Configurable timers for each question",
      path: "/quiz/create",
    },
    {
      icon: MessageSquare,
      title: "Live Chat",
      description: "Participants interact during sessions",
      path: "/live-chat",
    },
    {
      icon: Sparkles,
      title: "Question Generator",
      description: "AI-powered question creation from materials",
      path: "/quiz/create",
    },
    {
      icon: Trophy,
      title: "Performance Analytics",
      description: "Detailed results and student insights",
      path: "/teacher-dashboard",
    },
    {
      icon: BookOpen,
      title: "Quiz Library",
      description: "Browse and join available quizzes",
      path: "/quiz-library",
    },
    {
      icon: Lightbulb,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-purple-50 dark:from-slate-950 dark:via-indigo-950 dark:to-purple-950">
      ...
      <section className="relative overflow-hidden py-20 md:py-32">
        ...
        />
        <motion.div
          className="absolute -bottom-8 left-1/2 w-72 h-72 bg-cyan-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20"
          animate={{ x: [0, 30, 0] }}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button onClick={handleGetStarted} className="btn-primary text-lg px-8 py-6">
                {loggedIn ? "Go to Dashboard" : "Start Now"}{" "}
            ...
            <motion.div
              className="glass-panel flex justify-center gap-8 md:gap-16 mt-12 py-8 px-6"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              {[
                ...
                { label: "Students Learning", value: "50K+" },
              ...
              <div className="glass-panel bg-indigo-50/50 dark:bg-indigo-900/30 rounded-3xl p-8 border-indigo-200/50 dark:border-indigo-700/40">
                <div className="glass bg-white/80 dark:bg-slate-800/80 rounded-2xl p-6 space-y-4">
                  {[1, 2, 3].map((i) => (
                    <motion.div
                      key={i}
                      className="h-12 bg-gradient-to-r from-slate-200 to-slate-300 dark:from-slate-700 dark:to-slate-600 rounded-lg"
      ...
      {/* CTA Section with Floating Particles */}
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <Button
              ...
              size="lg"
              className="bg-white text-indigo-600 hover:bg-slate-100 font-bold text-lg px-8 py-6"
            >
